...
var _vuedraggable = __webpack_require__(5);
...
var _patternizerPreview = __webpack_require__(19);

var _patternizerPreview2 = _interopRequireDefault(_patternizerPreview);

var _rotationInput = __webpack_require__(21);

var _rotationInput2 = _interopRequireDefault(_rotationInput);

var _colorPicker = __webpack_require__(22);

var _colorPicker2 = _interopRequireDefault(_colorPicker);

var _rangeInput = __webpack_require__(24);
...
var app = new _vue2.default({
  ...
  components: {
    ...
    'patternizer-preview': _patternizerPreview2.default,
    'rotation-input': _rotationInput2.default,
    'color-picker': _colorPicker2.default,
    'range-input': _rangeInput2.default
  },
  data: Object.assign({
    currentStripeIdx: 0
  ...
  methods: {
    ...
    removeStripe: function removeStripe(index, event) {
      ...
      var newStripes = this.stripes.slice();
    ...
    onNewStripe: function onNewStripe() {
      var newStripe = Object.assign({}, this.stripes[this.currentStripeIdx]);
      newStripe.id = (0, _uniqueId2.default)();
      var newStripes = this.stripes.slice();
...
var patternizer = {
  ...
  isArray: function isArray(testObject) {
  ...
  DEGREES_RADIANS: function DEGREES_RADIANS(degrees) {
    return degrees * Math.PI / 180;
  },

  HEX_RGBA: function HEX_RGBA(color, alpha) {
  ...
  normalizeStripes: function normalizeStripes(stripes) {
  ...
  stripe: function stripe(canvas, options) {
...
(function ($) {
  ...
  $._farbtastic = function (container, options) {
    ...
    fb.initWidget = function () {
      ...
      $(container).html('<div class="farbtastic" style="position: relative">' + '<div class="farbtastic-solid"></div>' + '<canvas class="farbtastic-mask"></canvas>' + '<canvas class="farbtastic-overlay"></canvas>' + '</div>').find('*').attr(dim).css(dim).end().find('div>*').css('position', 'absolute');
      ...
      $.browser.msie || false && $('canvas', container).each(function () {
        ...
        $(e).attr(dim).css(dim).css('position', 'absolute').find('*').attr(dim).css(dim);
      });
    ...
    fb.drawMarkers = function () {
      ...
      var circles = [{ x: x1, y: y1, r: r, c: '#000', lw: lw + 1 }, { x: x1, y: y1, r: fb.markerSize, c: '#fff', lw: lw }, { x: x2, y: y2, r: r, c: c2, lw: lw + 1 }, { x: x2, y: y2, r: fb.markerSize, c: c1, lw: lw }];
